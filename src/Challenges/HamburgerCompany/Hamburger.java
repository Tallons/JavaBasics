...
public class Hamburger {
    ...
    public double itemizedHamburger() {
        ...
        if(this.additionOneName != null) {
            ...
            System.out.println("Added " + this.additionOneName + " for $ " + this.additionOnePrice);
        }
        if(this.additionTwoName != null) {
            hamburgerPrice += this.additionTwoPrice;
            System.out.println("Added " + this.additionTwoName + " for $ " + this.additionTwoPrice);
        }
        if(this.additionThreeName != null) {
            hamburgerPrice += this.additionThreePrice;
            System.out.println("Added " + this.additionThreeName + " for $ " + this.additionThreePrice);
        }
        if(this.additionFourName != null) {
            hamburgerPrice += this.additionFourPrice;
            System.out.println("Added " + this.additionFourName + " for $ " + this.additionFourPrice);
        }
